        ...
        <Drawer.Content className="bg-zinc-900 flex flex-col rounded-t-[10px] h-[45%] mt-24 fixed bottom-0 left-0 right-0 z-50 border-t border-zinc-800">
          <div className="p-4 bg-zinc-900 rounded-t-[10px] flex-1">
            ...
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-lg font-semibold text-white">Edit {selectedObj.type} #{selectedObj.id}</h2>
              <button
                ...
                {selectedObj.type === 'Box' && (
                    <>
                        <Slider
                            ...
                            valueDisplay={selectedObj.length.toFixed(2)}
                        ...
                        <Slider
                            ...
                            valueDisplay={selectedObj.width.toFixed(2)}
                        ...
                        <Slider
                            ...
                            valueDisplay={selectedObj.height.toFixed(2)}
                ...
                {selectedObj.type === 'Cylinder' && (
                    <>
                        <Slider
                            ...
                            valueDisplay={selectedObj.radius.toFixed(2)}
